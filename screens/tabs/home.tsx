    ...
    <SafeAreaView style={[defaultStyles.safeArea, { backgroundColor: currentColors.background }]}>
      ...
      <ScrollView style={defaultStyles.container} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <View style={defaultStyles.headerBox}>
          ...
          <Text style={[defaultStyles.title, { color: currentColors.text }]}>Hello, {currentUser?.displayName || 'User'}! 👋</Text>
        </View>
        ...
        {/* Section 3: Friends Activity Carousel */}
          ...
          return (
            ...
            >
              ...
              <View style={[styles.avatarRing, { borderColor: ringColor }]}>
                {friend.avatarUrl ? (
                  <Image source={{ uri: friend.avatarUrl }} style={defaultStyles.avatarMedium} />
                ) : (
                  <View style={[
                    defaultStyles.avatarSmall, 
        ...
        {remainingHabits.length === 0 ? (
          <View style={styles.emptyContainer}>
            <Text style={defaultStyles.subtitle}>🎉 Incredible job! You've crushed all your habits for today.</Text>
          </View>
        ) : (
