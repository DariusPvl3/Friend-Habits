        ...
        >
          ...
          >
            <View style={defaultStyles.headerBox}>
              <Text style={[defaultStyles.title, { color: currentColors.text }]}>Join the Habit Tracking Community</Text>
              <Text style={defaultStyles.subtitle}>Create an account to start locking in daily targets with your friends.</Text>
            </View>

            <View style={defaultStyles.form}>
              <Text style={[defaultStyles.label, { color: currentColors.text }]}>Email Address</Text>
              <TextInput
              ...
              <Text style={[defaultStyles.label, { color: currentColors.text, marginTop: 16 }]}>Password</Text>
              <View style={[defaultStyles.passwordInputContainer, { 
                backgroundColor: colorScheme === 'dark' ? '#1E293B' : '#FFF',
                borderColor: colorScheme === 'dark' ? '#334155' : '#CBD5E1' 
              }]}>
                <TextInput
              ...
              <Text style={[defaultStyles.label, { color: currentColors.text, marginTop: 16 }]}>Confirm Password</Text>
              <View style={[defaultStyles.passwordInputContainer, { 
                backgroundColor: colorScheme === 'dark' ? '#1E293B' : '#FFF',
                borderColor: colorScheme === 'dark' ? '#334155' : '#CBD5E1' 
              }]}>
